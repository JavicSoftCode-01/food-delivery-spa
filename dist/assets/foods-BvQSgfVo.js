import{F as p,n as g,O as f}from"./core-CP5HSxHI.js";import{f as b}from"./utils-OsXyF5Oc.js";import"./vendor-D67DkiDD.js";import"fs";import"path";import"crypto";import"child_process";import"os";import"./ui-DeEF8Jzz.js";function E(a){var u;setTimeout(()=>window.scrollTo(0,0),0),a.innerHTML=`<div class="food-container bg-white dark:bg-dark-bg-secondary rounded-xl p-3 border dark:border-dark-border space-y-3 mb-32 opacity-0 transform translate-y-4">
    ...
    <div id="foodsList" class="space-y-3"></div>
        ...
        <div class="grid grid-cols-3 gap-2 text-lg text-gray-600 dark:text-gray-300 mb-3">
          ...
          <div class="flex items-center gap-1 p-2 rounded-lg bg-orange-50 dark:bg-orange-900/20 transition-colors hover:bg-orange-100 dark:hover:bg-orange-900/30">
            ...
            <span class="font-semibold"><strong>${e.stock-f.getReservedStockForFood(e.id)}</strong></span>
          </div>
